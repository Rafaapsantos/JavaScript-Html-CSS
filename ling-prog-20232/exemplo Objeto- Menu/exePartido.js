// modalizar o exe dos partidos usando o vetor como parametro
...
function realizaOsVotos(){
 ...
 function calculaCandidatoComMaisVotos(vetor){
...
function exePartido(){
    ...
    realizaOsVotos()
    calculaCandidatoComMaisVotos(politicos)
